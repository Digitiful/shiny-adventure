...
const socialLinks = [
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/Digitiful',
    icon: Github,
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2">
              {navLinks.filter(link => link.href !== '/contact' && !link.href.startsWith('#')).map((link) => (
                <li key={link.href}>
          ...
          <div className="md:col-span-3">
             ...
             <div className="flex space-x-4 mb-4">
              {socialLinks.map((social, index) => (
                <Link key={`${social.name}-${index}`} href={social.href} className="text-muted-foreground hover:text-primary transition-colors">
